...
const FormBox = ({ bgImg }) => {
  ...
  const handleSubmit = async event => {
    ...
    // Check if the plan is premium (planId !== 1)
      ...
      <div className="form_box">
        <form className="form" onSubmit={handleSubmit}>
          <div className="row">
            <h2 className="mb-5 text-center form-header">Register</h2>
            <div className="col-lg-6">
              <Input onChange={e => setFullname(e.target.value)} name={"fullname"} labelText="Fullname" placeholder="Please Enter FullName" />
              <Input onChange={e => setUsername(e.target.value)} name={"username"} labelText="Username" placeholder="Please Enter Username" value={username} />
              <Input onChange={e => setEmail(e.target.value)} name={"email"} labelText="Email" type="email" placeholder="Please Enter Email" value={email} />
              <label>Profile Image</label>
              <input name="image" type="file" accept="image/*" onChange={photoUpload} />
              {image && <img width={250} height={250} src={image} alt="Profile preview" />}
            </div>
            <div className="col-lg-6">
              <Input onChange={e => setPassword(e.target.value)} name={"password"} labelText="Password" type="password" placeholder="Please Enter Password" value={password} />
              <Input onChange={e => setrepassword(e.target.value)} name={"rePassword"} labelText="Repeat Password" type="password" placeholder="Please Repeat Password" value={rePassword} />
            </div>
            {isError && <p className="error">{error.message}</p>}
            {isSuccess && <p className="success">Registration Successful!</p>}
            <div className="">
